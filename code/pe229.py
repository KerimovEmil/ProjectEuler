...
class Problem229:
    ...
    def solve(self):
        ...
        # Note: 25^2 mod 168 = 121, 121^2 mod 168 = 25, 1^1 mod 168 = 1

        # 3600 = 2^4 3^2 5^2  # 5^2 mod 168 = 25
        # 4624 = 2^4 17^2  # 17^2 mod 168 = 121
        # 12100 = 2^2 11^2 5^2  # 11^2 mod 168 = 121
        # 12321 = 3^2 37^2  # 37^2 mod 168 = 25
        # 14400= 2^6 3^2 5^2  # 5^2 mod 168 = 25
        # 18496= 2^6 17^2  # 17^2 mod 168 = 121
        # 20449= 11^2 13^2  # 13^2 mod 168 = 1
        # 24336= 2^4 3^2 13^2  # 13^2 mod 168 = 1
        # 26896= 41^2 2^4  # 41^2 mod 168 = 1
        # 30276= 2^2 3^2 29^2  # 29^2 mod 168 = 1
        # 32400= 2^4 3^4 5^2  # 5^2 mod 168 = 25
