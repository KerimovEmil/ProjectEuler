...
solved_quick_problems = [
    ...
    137, 139, 140, 144, 145, 187, 193, 197, 204, 229, 233, 235, 236, 243, 356, 486, 610, 668, 700, 753]

# todo make this the list to maintain eventually
bad_or_slow_solutions = [46, 96, 179, 185, 211, 266, 330, 345, 357, 401, 419, 420, 432]
